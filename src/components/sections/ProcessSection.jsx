          ...
          {PROCESS_STEPS.map((s, i) => (
            <div
              ...
              style={{
                ...
                padding: isMobile 
                  ? "32px 0" 
                  : `40px ${i < PROCESS_STEPS.length - 1 ? "36px" : "0"} 40px ${i > 0 ? "36px" : "0"}`,
                
                // Borders logic:
                // Desktop: Right borders between items
                // Mobile: Bottom borders between items
                borderRight: (!isMobile && !isTablet && i < PROCESS_STEPS.length - 1) 
                  ? "1px solid rgba(255,255,255,0.08)" 
                  : (isTablet && i % 2 === 0) ? "1px solid rgba(255,255,255,0.08)" : "none",
                
                borderBottom: isMobile && i < PROCESS_STEPS.length - 1 
                  ? "1px solid rgba(255,255,255,0.08)" 
                  : "none",
