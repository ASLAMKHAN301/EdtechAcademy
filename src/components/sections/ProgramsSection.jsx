...
import { Eyebrow, DisplayH2, SectionContainer, SectionHead, ArrowIcon } from "../ui";
  ...
  return (
    <section id="programs" style={{ background: CREAM, borderBottom: `1px solid ${BORDER}`, padding: "88px 0" }}>
      <SectionContainer>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 1, background: BORDER, border: `1px solid ${BORDER}` }}>
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }}>
        <div style={{ width: 48, height: 48, border: `1px solid ${BORDER}`, borderRadius: 2, background: CREAM, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <svg width="22" height="22" viewBox="0 0 22 22" fill={NAVY}><rect x="3" y="4" width="16" height="14" rx="1" /></svg>
        </div>
        <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: GOLD, background: GOLD_LT, padding: "4px 10px", borderRadius: 1 }}>
          {program.badge}
        </span>
      </div>
      ...
      <p style={{ fontSize: 14, color: STONE, lineHeight: 1.7, fontWeight: 300, flex: 1 }}>{program.desc}</p>

      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: 18, borderTop: `1px solid ${BORDER}` }}>
